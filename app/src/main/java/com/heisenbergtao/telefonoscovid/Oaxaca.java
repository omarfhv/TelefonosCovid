...
public class Oaxaca extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oaxaca);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnbajas1:
                ...
                intent1.setData(Uri.parse("tel: 951 516 1220"));
            ...
            case R.id.btnbajas2:
                ...
                intent12.setData(Uri.parse("tel:951 516 8242"));
