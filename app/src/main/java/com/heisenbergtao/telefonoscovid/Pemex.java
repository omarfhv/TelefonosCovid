...
public class Pemex extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pemex);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnbajas1:
                ...
                intent1.setData(Uri.parse("tel:551 944 2500"));
            ...
            case R.id.btnbajas2:
                ...
                intent12.setData(Uri.parse("tel:551 944 250 0"));
