...
public class QuejasTrabajadoresImss extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quejas_trabajadores_imss);
...
// SI NOS CONCEDE EL PERMISO Y LANZA LA LLAMADA
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.botoncorreo:
                ...
                emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{"zoe.robledo@imss.com.mx"});
                ...
                emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "QUEJAS SOBRE:");
                // Obtenemos la referencia al texto y lo pasamos al Email Intent
                try {
                    //Enviamos el Correo iniciando una nueva Activity con el emailIntent.
                    startActivity(Intent.createChooser(emailIntent, "Enviar E-mail..."));
                } catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(QuejasTrabajadoresImss.this, "No hay ningun cliente de correo instalado.", Toast.LENGTH_SHORT).show();
                }
                finish();
                break;
    ...
    private void validaPermisos() {
        ...
        if ((shouldShowRequestPermissionRationale(CALL_PHONE))) {
            AlertDialog.Builder dialogo = new AlertDialog.Builder(QuejasTrabajadoresImss.this);
