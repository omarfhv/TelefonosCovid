...
public class Chiapas extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chiapas);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnbajas1:
                ...
                intent1.setData(Uri.parse("tel:800 772 2020"));
            ...
            case R.id.btnbajas2:
                ...
                intent12.setData(Uri.parse("tel:961 607 7674"));
