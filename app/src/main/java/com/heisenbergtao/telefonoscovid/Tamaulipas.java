...
public class Tamaulipas extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamaulipas);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnbajas1:
                ...
                intent1.setData(Uri.parse("tel: 834 318 6320"));
            ...
            case R.id.btnbajas2:
                ...
                intent12.setData(Uri.parse("tel:834 318 6321"));
