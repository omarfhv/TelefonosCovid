...
public class Durango extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_durango);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btnbaja2:
                ...
                intent12.setData(Uri.parse("tel:618 325 1573"));
            ...
            case R.id.btnbaja3:
                ...
                intent13.setData(Uri.parse("tel:618 134 7042"));
